...
const product = {
  name: "Basic Bacterial Medicine",
  price: "₹996",
  href: "#",
  breadcrumbs: [
    { id: 1, name: "Cardiology", href: "#" },
    { id: 2, name: "Immunotherapy", href: "#" },
  ],
  images: [
    {
      src: "https://www.medibyte.in/wp-content/uploads/2019/05/Alup-Tabs.jpg",
      alt: "Alt medicine Image",
    },
    {
      src: "https://www.medibyte.in/wp-content/uploads/2019/05/Alup-Tabs.jpg",
      alt: "Alt medicine Image",
  ...
  sizes: [
    { name: "Small Mg", inStock: true },
    { name: "Medium Mg", inStock: true },
    { name: "High Mg", inStock: true },
  ],
  description:
    'Great Medicine',
  highlights: [
